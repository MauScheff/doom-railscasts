;;; doom-railscasts-one-theme.el --- Railscasts port w/ doom-one background -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-railscasts-one-theme nil
  "Options for the `doom-railscasts-one' theme."
  :group 'doom-themes)

;;
;;; Theme definition

(def-doom-theme doom-railscasts-one
  "Railscasts port with Doom One background."

  ;; name        default   256       16
  ((bg         '("#282c34" "black" "black"      )) ;; doom-one background
