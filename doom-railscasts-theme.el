;;; doom-railscasts-theme.el --- port of the Railscasts (VS Code/TextMate) theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-railscasts-theme nil
  "Options for the `doom-railscasts' theme."
  :group 'doom-themes)
...
(def-doom-theme doom-railscasts
  "A dark theme ported from the Railscasts VS Code/TextMate theme."
